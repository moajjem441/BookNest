    ...
    <div className="min-h-dvh w-full bg-slate-950 flex items-center justify-center relative overflow-hidden px-4 py-24 selection:bg-blue-500 selection:text-white">
      ...
      <div className="max-w-xl w-full relative z-10 my-auto">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">Join the Neighborhood</h1>
          <p className="text-slate-400 text-xs sm:text-sm mt-1 px-2">Share physical books and read digital PDFs with local readers.</p>
        </div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Location Field */}
            <div className="space-y-1">
              <label className="text-xs font-semibold text-slate-300 ml-1">Neighborhood / Area</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-500">
          ...
          <div className="mt-6 text-center text-xs sm:text-sm text-slate-400 border-t border-slate-800/80 pt-4">
            ...
            <Link href="/login" className="font-bold text-blue-400 hover:text-cyan-300 transition-colors">
              Sign In
            </Link>
          </div>
        ...
        <p className="text-center text-[11px] text-slate-600 mt-5">
          By registering, you agree to BookNest's Community Guidelines & Copyright Terms.
        </p>
